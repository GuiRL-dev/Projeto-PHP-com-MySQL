...
<head>
  ...
  <style>
    .custom-img {
      ...
      height: 70%;
      /* Define a altura como automática para manter a proporção da imagem */
        ...
        <div class="card-deck col-sm-6 col-md-4" style="max-width: 20rem;">
          <div class="card">
            <div class="d-flex justify-content-center align-items-center" style="height: 250px;">
              <!-- Alinha a imagem ao centro verticalmente e horizontalmente -->
              <img src="img/<?php echo ("$imagem") ?> " class="card-img-top custom-img" alt="..." width="250">
            </div>
            <div class="card-body">
              <h5 class="card-title text-center">
                <?php echo ("$desc_produto") ?>
              </h5>
              <p class="card-text text-center">R$
